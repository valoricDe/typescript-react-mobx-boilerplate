...
// Module Utils
const moduleUtils = require('gql2ts/util/module');
...
let transformed = moduleUtils.generateModule(options.moduleName, interfaces);
moduleUtils.writeModuleToFile(options.outputFile, transformed);
